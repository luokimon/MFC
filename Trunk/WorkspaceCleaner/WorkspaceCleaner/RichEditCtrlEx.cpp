...
void CRichEditCtrlEx::AddBlackText(const CString& str)
{
	AddColorText(str, RGB(0, 0, 0));
}

void CRichEditCtrlEx::AddRedText(const CString& str)
{
	AddColorText(str, RGB(255, 0, 0));
}

void CRichEditCtrlEx::AddGreenText(const CString& str)
{
	AddColorText(str, RGB(0, 255, 0));
}

void CRichEditCtrlEx::AddBlueText(const CString& str)
{
