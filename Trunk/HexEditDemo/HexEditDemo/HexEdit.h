// XTHexEdit.h interface for the CHexEdit class.
//
...
//===========================================================================
// Summary:
//     CHexMemDC is a CDC derived class. CHexMemDC is an extension of CDC
...
//===========================================================================
class CHexMemDC : public CDC
{
	DECLARE_DYNAMIC(CHexMemDC)

public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Constructs a CHexMemDC object used for flicker free drawing.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	CHexMemDC(CDC* pDC,const CRect& rect,COLORREF clrColor=GetSysColor(COLOR_3DFACE));

	//-----------------------------------------------------------------------
	// Summary:
	//     Destroys a CHexMemDC object, handles cleanup and deallocation
	//-----------------------------------------------------------------------
	virtual ~CHexMemDC();
...
#define WM_HEXEDIT_CHANGE	WM_USER + 836
//===========================================================================
// Summary:
//     CHexEdit is a CEdit derived class. It is used to create an edit control
...
protected:
	...
	// Remarks:
	//     EditMode type defines the constants used by the CHexEdit
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Constructs a CHexEdit object
	//-----------------------------------------------------------------------
	CHexEdit();

	//-----------------------------------------------------------------------
	// Summary:
	//     Destroys a CHexEdit object, handles cleanup and deallocation
	//-----------------------------------------------------------------------
	virtual ~CHexEdit();
...
AFX_INLINE UINT CHexEdit::OnGetDlgCode()  {
	return DLGC_WANTALLKEYS;
}
AFX_INLINE void CHexEdit::SetOptions(BOOL bShowAddress, BOOL bShowHex, BOOL bShowAscii, BOOL bAddressIsWide) {
...
AFX_INLINE void CHexEdit::SetBPR(int nBytePerRow) {
	m_nBytePerRow = nBytePerRow; m_bUpdate = TRUE; RepositionCaret(m_nCurrentAddress);
}
AFX_INLINE BOOL CHexEdit::IsSelected() {
	return m_nSelStart != 0xffffffff;
}
AFX_INLINE CSize CHexEdit::GetSel() {
	return CSize(m_nSelStart, m_nSelEnd);
}
AFX_INLINE void CHexEdit::SetBackColor(COLORREF crBack) {
	m_crBack = crBack;
}
AFX_INLINE void CHexEdit::SetTextColor(COLORREF crText) {
	m_crText = crText;
}
AFX_INLINE void CHexEdit::SetDisabledBackColor(COLORREF crDisabledBack) {
	m_crDisabledBack = crDisabledBack;
}
AFX_INLINE void CHexEdit::SetDisabledTextColor(COLORREF crDisabledText) {
	m_crDisabledText = crDisabledText;
}
AFX_INLINE void CHexEdit::SetHighlightTextColor(COLORREF crHighlightText) {
	m_crHighlightText = crHighlightText;
}
AFX_INLINE void CHexEdit::SetHighlightBackColor(COLORREF crHighlightBack) {
	m_crHighlightBack = crHighlightBack;
}
AFX_INLINE void CHexEdit::SetDisabledHighlightTextColor(COLORREF crDisabledHighlightText) {
	m_crDisabledHighlightText = crDisabledHighlightText;
}
AFX_INLINE void CHexEdit::SetDisabledHighlightBackColor(COLORREF crDisabledHighlightBack) {
	m_crDisabledHighlightBack = crDisabledHighlightBack;
}
AFX_INLINE COLORREF CHexEdit::GetBackColor() {
	return m_crBack;
}
AFX_INLINE COLORREF CHexEdit::GetTextColor() {
	return m_crText;
}
AFX_INLINE COLORREF CHexEdit::GetDisabledBackColor() {
	return m_crDisabledBack;
}
AFX_INLINE COLORREF CHexEdit::GetDisabledTextColor() {
	return m_crDisabledText;
}
AFX_INLINE COLORREF CHexEdit::GetHighlightTextColor() {
	return m_crHighlightText;
}
AFX_INLINE COLORREF CHexEdit::GetHighlightBackColor() {
	return m_crHighlightBack;
}
AFX_INLINE COLORREF CHexEdit::GetDisabledHighlightTextColor() {
	return m_crDisabledHighlightText;
}
AFX_INLINE COLORREF CHexEdit::GetDisabledHighlightBackColor() {
	return m_crDisabledHighlightBack;
}
AFX_INLINE void CHexEdit::EnableCaret(bool bEnable) {
	m_bShowCaret = bEnable;
}
AFX_INLINE bool CHexEdit::SetAllowDeletes(bool bVal) {
	const bool bOldVal = m_bAllowDeletes; m_bAllowDeletes = bVal; return bOldVal;
}
AFX_INLINE bool CHexEdit::GetAllowDeletes() const {
