...
void CTreeCtrlEx::OnBegindrag(NMHDR* pNMHDR, LRESULT* pResult)
{
	...
	*pResult = 0;
	...
	//m_pDragImage->Create(16, 16, ILC_COLOR8, 0, 4);
	if (!m_pDragImage)
		return;
